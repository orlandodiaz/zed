...
fn panels_page() -> SettingsPage {
    fn project_panel_section() -> [SettingsPageItem; 30] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Folder Chevrons",
                description: "Show a disclosure chevron before the folder icon for directories in the project panel (Finder/IntelliJ style). Only applies when Folder Icons is on.",
                field: Box::new(SettingField {
                    json_path: Some("project_panel.folder_chevrons"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
